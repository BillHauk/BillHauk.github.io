...
### RCA Indices, Multinational Production, and the Ricardian Trade Model (with Kaveri Deb)
...
### Electoral Regime and Trade Policy (with John Hatfield)
...
### The Return of Convergence in the U.S. States (with Janice Boucher Breuer and John McDermott)
...
### A Monte Carlo Study of Growth Regressions (with Romain Wacziarg)
...
### Small States, Big Pork (with Romain Wacziarg)
